    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col">
        <div className="bg-gradient-to-r from-red-600 to-orange-600 text-white p-4 flex items-center">
          <button onClick={onBackToMenu} className="mr-4">
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-gradient-to-r from-red-600 to-orange-600 text-white p-4 flex items-center shadow-lg">
        <button onClick={onBackToMenu} className="mr-4 hover:bg-white/20 p-2 rounded-full transition-colors">
          <ArrowLeft className="w-6 h-6" />
        </button>
        <div>
          <h1 className="text-xl font-bold">Mi Carrito</h1>
          <p className="text-red-100 text-sm">{itemCount} producto{itemCount !== 1 ? 's' : ''}</p>
        </div>
      </div>
            ...
            <div className="p-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-red-600 font-bold text-xl mb-3">S/ {item.price.toFixed(2)}</p>
                ...
                {expandedItem === item.id && (
                  <div className="mt-3">
                    <textarea
                      ...
                      className="w-full p-3 border border-gray-200 rounded-xl resize-none text-sm focus:ring-2 focus:ring-red-500 focus:border-transparent"
                      rows={3}
                    />
                  </div>
                )}
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 shadow-lg">
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-red-500 hover:bg-red-600 text-white py-4 rounded-2xl font-bold text-lg transition-colors shadow-lg"
          >
